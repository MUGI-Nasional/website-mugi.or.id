...
(function($) {
    $.fn.x_editor = function(options) { 
        // add library 
        addLib('Content/js/editor.table.min.js');
        addLib('Content/js/editor.script.js');
        // add another librarary 
        addLib('Content/js/editor.helper.js');
...
function textNode(height, txtDef, oDoc, id, t1, t2) {
    ...
    return '<div class="x-editor-initiator" id="' + id + '">' +
            ...
            '<div id="' + oDoc + '" style="min-height:' + height + 'px;height: 150px;overflow: auto" spellcheck="false" allowtransparency="true" designMode="on" class="x-editor" contenteditable="true">' + txtDef + '</div>' +
            menuclick() +
